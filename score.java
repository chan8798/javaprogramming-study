...
public class score {
	...
	public String[] card; // blackjack클래스 card 집합 모음 배열
	public List<Object> Ar; //blackjack클래스 사용자 카드 패
	public List<Object> Arr;//blackjack클래스 딜러 카드 패
	...
	public int n() {//사용자 카드 패
		...
		for(int i=0; i<Ar.size(); i++) {
			if(Ar.get(i)=="A") {//A가 존재 할떄 선택한 숫자(1,11)을 namescore 메소드 이동
				Object a=Ar.get(i);
	    		namescore(a,Ars,ch);
	    	}
